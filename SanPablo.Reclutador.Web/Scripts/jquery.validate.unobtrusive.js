...
(function ($) {
    ...
    $jQval.addMethod('lessthanorequaldate', function (value, element, params) {
        ...
        var dateToCompareAgainst = $.datepicker.parseDate('yy-mm-dd', $(params).val());
    ...
    adapters.add('lessthanorequaldate', ['other'], function (options) {
