...
ALTER TABLE RECLU_PERSO_CRITERIO ADD CONSTRAINT RECPERS_CRI_IDERECPE_EX_CAT_FK 
  FOREIGN KEY (IDERECLPERSOEXAMNCAT) REFERENCES RECL_PERS_EXAM_CAT (IDERECLPERSOEXAMNCAT);
